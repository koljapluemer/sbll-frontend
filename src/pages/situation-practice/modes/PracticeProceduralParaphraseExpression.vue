...
const novelTaskTypes: TaskType[] = ['MemorizeFromNative', 'UnderstandNativeFromSentence']
const practicingTaskTypes: TaskType[] = ['FormSentence', 'RecallFromNative']
const finalTaskType: TaskType = 'ChallengeTryToExpress'
