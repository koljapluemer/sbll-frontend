...
import type { ChallengeTryToExpressTask } from './interface'

defineOptions({ name: 'ChallengeTryToExpressTask' })

const props = defineProps<{
  task: ChallengeTryToExpressTask
}>()
